...
var name = shape.student(name:"Bob")
...
let testCircle = Circle(radius: 6.50, name: "my test circle")
testCircle.area()
...
//}
////r
////let testCircle = Circle(radius: 5.0, name: "testCircle")
////testCircle.area()
//: - Experiment:
